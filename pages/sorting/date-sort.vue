                ...
                <thead>
                  <tr>
                    ...
                    <th class="px-6 py-3 text-left text-md font-medium text-gray-600 uppercase tracking-wider ">
                      <nuxt-link to="/sorting/name-sort">Users</nuxt-link>
                    </th>
                    <th class="px-6 py-3 text-left text-md font-medium text-gray-600 uppercase tracking-wider"><nuxt-link>Joined
